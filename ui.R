...
## App Meta Data----------------------------------------------------------------
APP_TITLE  <<- "Non-Response Bias"
APP_DESCP  <<- paste(
  "This app visualizes how the confidence level and sample size affect the outcome 
  confidence interval for a single proportion. The app also explores non-response bias 
  when respondents are chosen from a population with a different true proportion 
  ...
  dashboardBody(
    ...
    tabItems(
      tabItem(
        ...
        p("This app visualizes how the confidence level and sample size affect the 
        outcome confidence interval for a single proportion. The app also explores 
          non-response bias when respondents are chosen from a population with a 
          different true proportion causing non-response bias."),
        br(),
        h2("Instructions"),
        tags$ol(
          tags$li(
            "Move the sample size and level sliders to see how they affect confidence 
            intervals for the proportion of Penn State students who are residents of Pennsylvania."
          ),
          tags$li(
        ...
        br(),
        h2("Acknowledgements"),
        p("This app was developed and programmed by Zhuolin Luo 
          extending earlier work by  Yingjie (Chelsea) Wang.",
        br(),
        br(),
        br(),
